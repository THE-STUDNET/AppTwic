...
eval mkdir -p "./res/{drawable-ldpi,drawable-hdpi,drawable-mdpi,drawable-xhdpi,drawable-xxhdpi,drawable-xxxhdpi,drawable}"
# Show the user some progress by outputing all commands being run.
set -x

splash_base="./splash.png"
icon_base="./icon.png"
not_icon_base="./noticon.png"

icon_base_ios="./iconios.png"
background="#ffffff"
...
$icons -resize 144 "./res/icon/android/drawable-xxhdpi.png"
$icons -resize 192 "./res/icon/android/drawable-xxxhdpi.png"

icons="convert $not_icon_base -background transparent"

$icons -resize 16 "./android/res/icon.png"
$icons -resize 32 "./android/res/drawable/icon.png"
$icons -resize 36 "./android/res/drawable-ldpi/icon.png"
$icons -resize 72 "./android/res/drawable-hdpi/icon.png"
$icons -resize 48 "./android/res/drawable-mdpi/icon.png"
$icons -resize 96 "./android/res/drawable-xhdpi/icon.png"
$icons -resize 144 "./android/res/drawable-xxhdpi/icon.png"
$icons -resize 192 "./android/res/drawable-xxxhdpi/icon.png"

icons="convert $icon_base_ios -background #159f9b"
